...
if (!supabaseUrl || !supabaseServiceKey) {
  ...
  console.log('Pour créer la table precision_scores, utilisez le SQL Editor de Supabase:\n');

  const sql = readFileSync('./scripts/precision_scores_schema.sql', 'utf8');
  console.log(sql);
...
console.log('📝 Migration pour la table precision_scores...\n');
...
console.log('Ou copiez le contenu de: scripts/precision_scores_schema.sql\n');
