...
**Fichiers** :
- [AGENTS/SENTINEL/agent.js](tools/machine_a_evenements/AGENTS/SENTINEL/agent.js) - Agent amélioré
- [AGENTS/SENTINEL/duplicate_detector.mjs](tools/machine_a_evenements/AGENTS/SENTINEL/duplicate_detector.mjs) - Fonctions de détection
- [AGENTS/SENTINEL/STORAGE/OUTPUT/sentinel_audit_report.json](tools/machine_a_evenements/AGENTS/SENTINEL/STORAGE/OUTPUT/sentinel_audit_report.json) - Rapport d'audit
...
**Fichiers** :
- [AGENTS/GENESIS/agent_intelligent.mjs](tools/machine_a_evenements/AGENTS/GENESIS/agent_intelligent.mjs) - Génération intelligente
- [AGENTS/GENESIS/coverage_analyzer.mjs](tools/machine_a_evenements/AGENTS/GENESIS/coverage_analyzer.mjs) - Analyse de couverture
...
cd tools/machine_a_evenements/AGENTS/GENESIS
