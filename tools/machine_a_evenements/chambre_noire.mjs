    ...
    for (const item of queueItems) {
        ...
        while (attempt < MAX_RETRIES && !success) {
            ...
            try {
                ...
                const trinityInputPath = path.resolve('./tools/machine_a_evenements/AGENTS/TRINITY/STORAGE/INPUT/task.json');
                ...
                execSync(`node agent.js`, {
                    cwd: path.resolve('./tools/machine_a_evenements/AGENTS/TRINITY'),
                    stdio: 'inherit'
                });
                ...
                execSync(`node agent.js`, {
                    cwd: path.resolve('./tools/machine_a_evenements/AGENTS/VERITAS'),
                    stdio: 'inherit'
                });

                const veritasOutputPath = path.resolve('./tools/machine_a_evenements/AGENTS/VERITAS/STORAGE/OUTPUT/veritas_result.json');
                ...
                if (validationResult.validation.isValid) {
                    ...
                    const rexpInputPath = path.resolve('./tools/machine_a_evenements/AGENTS/REXP/STORAGE/INPUT/final_task.json');
