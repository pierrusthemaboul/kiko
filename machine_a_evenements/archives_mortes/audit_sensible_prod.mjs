...
// On utilise l'URL de PROD car c'est là que se trouvent les 3000 illustrations
...
async function audit() {
    ...
    console.log(`🔍 Audit de la table "evenements" sur PROD (${supabaseUrl})...`);
    ...
    if (uniqueResults.length === 0) {
        console.log('✅ Aucun événement sensible trouvé en PROD.');
        return;
    }
